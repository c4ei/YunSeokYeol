...
import (
	...
	"github.com/c4ei/c4exd/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that c4exd doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
