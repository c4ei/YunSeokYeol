...
func (x *C4exdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "C4exdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *C4exdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
