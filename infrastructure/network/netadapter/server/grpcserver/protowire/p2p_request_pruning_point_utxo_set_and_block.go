...
func (x *C4exdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "C4exdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *C4exdMessage_RequestPruningPointUTXOSet) fromAppMessage(
