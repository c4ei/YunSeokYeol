...
func (x *C4exdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "C4exdMessage_Reject is nil")
	}
...
func (x *C4exdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
