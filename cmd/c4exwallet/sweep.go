...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libc4exwallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libc4exwallet.C4exwalletdUTXOsTolibc4exwalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
